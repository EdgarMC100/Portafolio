...
module.exports = {
  ...
  output: {
    //donde se guardara o se mandara nuestro proyecto
  ...
  resolve: {
    //Indicando con que archivos se trabajara
    extensions: [".js", ".jsx"],
  },
  module: {
    //modulo que contendra las reglas de nuestro proyecto
    rules: [
      {
  ...
  plugins: [
    //Plugin generar un index.html de public a dist para produccion
